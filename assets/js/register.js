...
document.addEventListener("DOMContentLoaded", () => {
  ...
  UsersDB.onupgradeneeded = function (e) {
    ...
    bidsTable.createIndex("projTitle", "projTitle", { unique: false });
    bidsTable.createIndex("username", "username", { unique: false });
    bidsTable.createIndex("yearsExperince", "yearsExperince", {
      unique: false,
    });
    bidsTable.createIndex("desciption", "description", { unique: false });
    bidsTable.createIndex("attachedFile", "attachedFile", { unique: false });
